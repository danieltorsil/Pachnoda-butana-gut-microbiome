...
library(dplyr)
library(ggpubr)
p = plot_richness(rarefy_even_depth(physeq1, rngseed = 711), x="SampleName", color = "Area", measures=c("Observed", "Shannon", "Simpson")) + xlab("") + ylab("") # + geom_boxplot(alpha = .4, position=position_dodge(1)) + theme_light() + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + scale_x_discrete(limits = new_order)
p = p + theme_light() + theme(axis.text.x = element_text(angle = 45, hjust = 1)) + scale_x_discrete(limits = new_order)
p = p +geom_point(size = 3)

alpha_div = p + scale_color_manual(values = c('#6cb895', '#B97A95', '#F6AE99', '#f0c36e'))
alpha_div = p + scale_color_manual(values = c('#CEB992', '#73937E', '#8c86a3', '#db7551'))
alpha_div$data$Area
ASV_P1 = subset(alpha_div$data, Area %in% c('P1'))
ASV_P1 = subset(ASV_P1, variable %in% c('Observed'))
ASV_P2 = subset(alpha_div$data, Area %in% c('P2'))
ASV_P2 = subset(ASV_P2, variable %in% c('Observed'))
ASV_P3 = subset(alpha_div$data, Area %in% c('P3'))
ASV_P3 = subset(ASV_P3, variable %in% c('Observed'))
ASV_P4 = subset(alpha_div$data, Area %in% c('P4'))
ASV_P4 = subset(ASV_P4, variable %in% c('Observed'))
stderror_function <- function(a) sd(a) / sqrt(length(a))
mean_function <- function(a) sum(a) / length(a)

stderror <- stderror_function(ASV_P1$value)
mean <- mean_function(ASV_P1$value)
```
...
rare_physeq1 = rarefy_even_depth(physeq1, rngseed = 711)
rich = estimate_richness(rare_physeq1)
```

  
```{r echo=FALSE, warning=FALSE, comment=FALSE}
wilcox.test(rich$Observed[sample_data(rare_physeq1)$Area == "P1"], rich$Observed[sample_data(rare_physeq1)$Area == "P2"])
wilcox.test(rich$Shannon[sample_data(rare_physeq1)$Area == "P1"], rich$Shannon[sample_data(rare_physeq1)$Area == "P2"])
wilcox.test(rich$Simpson[sample_data(rare_physeq1)$Area == "P1"], rich$Simpson[sample_data(rare_physeq1)$Area == "P2"])

wilcox.test(rich$Observed[sample_data(rare_physeq1)$Area == "P1"], rich$Observed[sample_data(rare_physeq1)$Area == "P3"])
wilcox.test(rich$Shannon[sample_data(rare_physeq1)$Area == "P1"], rich$Shannon[sample_data(rare_physeq1)$Area == "P3"])
wilcox.test(rich$Simpson[sample_data(rare_physeq1)$Area == "P1"], rich$Simpson[sample_data(rare_physeq1)$Area == "P3"])

wilcox.test(rich$Observed[sample_data(rare_physeq1)$Area == "P1"], rich$Observed[sample_data(rare_physeq1)$Area == "P4"])
wilcox.test(rich$Shannon[sample_data(rare_physeq1)$Area == "P1"], rich$Shannon[sample_data(rare_physeq1)$Area == "P4"])
wilcox.test(rich$Simpson[sample_data(rare_physeq1)$Area == "P1"], rich$Simpson[sample_data(rare_physeq1)$Area == "P4"])



wilcox.test(rich$Observed[sample_data(rare_physeq1)$Area == "P2"], rich$Observed[sample_data(rare_physeq1)$Area == "P3"])
wilcox.test(rich$Shannon[sample_data(rare_physeq1)$Area == "P2"], rich$Shannon[sample_data(rare_physeq1)$Area == "P3"])
wilcox.test(rich$Simpson[sample_data(rare_physeq1)$Area == "P2"], rich$Simpson[sample_data(rare_physeq1)$Area == "P3"])

wilcox.test(rich$Observed[sample_data(rare_physeq1)$Area == "P2"], rich$Observed[sample_data(rare_physeq1)$Area == "P4"])
wilcox.test(rich$Shannon[sample_data(rare_physeq1)$Area == "P2"], rich$Shannon[sample_data(rare_physeq1)$Area == "P4"])
wilcox.test(rich$Simpson[sample_data(rare_physeq1)$Area == "P2"], rich$Simpson[sample_data(rare_physeq1)$Area == "P4"])


wilcox.test(rich$Observed[sample_data(rare_physeq1)$Area == "P3"], rich$Observed[sample_data(rare_physeq1)$Area == "P4"])
wilcox.test(rich$Shannon[sample_data(rare_physeq1)$Area == "P3"], rich$Shannon[sample_data(rare_physeq1)$Area == "P4"])
wilcox.test(rich$Simpson[sample_data(rare_physeq1)$Area == "P3"], rich$Simpson[sample_data(rare_physeq1)$Area == "P4"])
```
